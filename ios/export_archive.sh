ARCHIVEPATH="/Users/earyzhe/Library/Developer/Xcode/Archives/`date +"%Y-%m-%d"`/Runner `date +"%Y-%m-%d %H:%M"`"
EXPORTOPTIONSPLISTPATH="/Users/earyzhe/dev/FlutterProjects/dial_in_v1/ios/Runner/exportOptions.plist"
EXPORTPATH="/Users/earyzhe/dev/FlutterProjects/dial_in_v1/ios/Runner.ipa"
